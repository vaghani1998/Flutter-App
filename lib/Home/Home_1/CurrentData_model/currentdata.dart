...
WetData wetDataFromJson(String str) => WetData.fromJson(json.decode(str));

String wetDataToJson(WetData data) => json.encode(data.toJson());
...
class WetData {
  ...
  factory WetData.fromJson(Map<String, dynamic> json) => WetData(
        day: json["day"],
        icon: json["icon"],
        min: json["min"],
        max: json["max"],
